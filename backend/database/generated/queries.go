...
func (e _OrderQueryImpl[T]) CreateOrder(ctx context.Context, customerName string, customerEmail string, total float64) (int, error) {
	var sb strings.Builder
	_params := make([]any, 0, 3)

	sb.WriteString("INSERT INTO orders (customer_name, customer_email, total) VALUES (?, ?, ?)")
	_params = append(_params, customerName, customerEmail, total)
